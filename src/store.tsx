...
export function StoreProvider({children}:{children:ReactNode}){
 ...
 const value=useMemo(()=>({projects,people,workspace,workspaceRole,loading,error,collections,selected,toggleSelected,clearSelected,addProject,updateProject,archiveSelected,setSelectedVisibility,createCollection,renameCollection,toggleProjectInCollection,addSelectedToCollection,reload}),[projects,people,workspace,workspaceRole,loading,error,collections,selected,reload,persist])
