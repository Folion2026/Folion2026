...
export function StoreProvider({children}:{children:ReactNode}){
 ...
 const value=useMemo(()=>({projects,people,workspace,workspaceRole,loading,error,collections,selected,toggleSelected,clearSelected,addPerson,addProject,updateProject,deleteProject,archiveSelected,setSelectedVisibility,createCollection,renameCollection,toggleProjectInCollection,addSelectedToCollection,reload}),[projects,people,workspace,workspaceRole,loading,error,collections,selected,reload,persist,addPerson])
