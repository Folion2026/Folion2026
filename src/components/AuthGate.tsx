...
export default function AuthGate({children}:{children:ReactNode}){
 ...
 const submit=async(event:FormEvent)=>{event.preventDefault();setSending(true);const error=await signIn(email);setSending(false);setMessage(error||'Check your email for the secure Folion sign-in link.')}
