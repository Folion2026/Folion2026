import {FileText,Image as ImageIcon,RotateCcw,ZoomIn,ZoomOut} from 'lucide-react'
...
const isImageAsset=(asset?:Asset)=>!asset||imageTypes.has(asset.type)||Boolean(asset.mimeType?.startsWith('image/'))
