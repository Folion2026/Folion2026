...
const sourceStatus=(asset:Asset)=>asset.lifecycleStatus==='deleted'?'Source file removed after analysis and approval':asset.retentionKind==='temporary_source'&&asset.lifecycleStatus?asset.lifecycleStatus.replaceAll('_',' '):''
