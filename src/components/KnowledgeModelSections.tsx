...
export default function KnowledgeModelSections({project}:{project?:Project|null}){
 ...
 const hasContent=approvedDraft.length>0||reviewedFacts.length>0||safe.team.length>0
 ...
 return <div className="approved-knowledge">
  ...
  {(reviewedFacts.length>0||safe.team.length>0)&&<section className="structured-knowledge"><div><p className="eyebrow">Structured knowledge</p><h2>Approved information for reuse</h2></div><div className="structured-knowledge-grid">
