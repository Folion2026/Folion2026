...
const tenderSchema = {
  ...
  required: [
    ...
    "mandatory_roles",
    "desirable_roles",
    "relevant_project_characteristics",
    "geography",
    "sector_typology",
    "scale_complexity",
    "evidence_gaps",
  ...
  properties: {
    ...
    opportunity_project: { type: "ARRAY", items: { type: "STRING" } },
    ...
    mandatory_roles: { type: "ARRAY", items: { type: "STRING" } },
    desirable_roles: { type: "ARRAY", items: { type: "STRING" } },
    relevant_project_characteristics: { type: "ARRAY", items: { type: "STRING" } },
    geography: { type: "ARRAY", items: { type: "STRING" } },
    sector_typology: { type: "ARRAY", items: { type: "STRING" } },
    scale_complexity: { type: "ARRAY", items: { type: "STRING" } },
